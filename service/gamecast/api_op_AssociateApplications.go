...
// If a customer want to start stream sessions with different applications on the
// same stream group, he needs to call this API to associate those applications to
// that stream group beforehand. Example CLI input aws gamecast
// associate-applications --identifier
