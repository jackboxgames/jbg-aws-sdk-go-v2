...
// Customer call this API to set up a new stream session connection. End players
// can use the signal response in the response to connect to active streams.
// Example CLI input aws gamecast create-stream-session-connection --identifier
// arn:aws:gamecast:us-west-2:123456789012:streamgroup/33gveJpz0
// --stream-session-identifier
// arn:aws:gamecast:us-west-2:123456789012:streamsession/33gveJpz0/1a3uWe5W0
// --signal-request "webrtc-ice-offer-in-text"
...
func (c *Client) addOperationCreateStreamSessionConnectionMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addCreateStreamSessionConnectionResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opCreateStreamSessionConnectionResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opCreateStreamSessionConnectionResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opCreateStreamSessionConnectionResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addCreateStreamSessionConnectionResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opCreateStreamSessionConnectionResolveEndpointMiddleware{
