...
// aws gamecast list-stream-groups
...
type ListStreamGroupsOutput struct {
	...
	// A summary view of all the applications owned by the calling AWS account.
...
func (c *Client) addOperationListStreamGroupsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addListStreamGroupsResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opListStreamGroupsResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opListStreamGroupsResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opListStreamGroupsResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addListStreamGroupsResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opListStreamGroupsResolveEndpointMiddleware{
