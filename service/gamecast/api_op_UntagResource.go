...
// Example CLI input aws gamecast untag-resource --resource-arn
// arn:aws:gamecast:us-west-2:123456789012:streamgroup/33gveJpz0 --tags '["key1"]'
...
type UntagResourceInput struct {
	...
	// Tag keys to remove. The maximum number of keys is 50.
	//
	// This member is required.
	TagKeys []string
