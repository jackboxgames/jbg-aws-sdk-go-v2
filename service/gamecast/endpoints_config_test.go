...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-gamecast.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gamecast.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gamecast.dev",
			expectURL:     aws.String("https://env-gamecast.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-gamecast.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-gamecast.dev",
			expectURL:     aws.String("http://config-gamecast.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-gamecast.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-gamecast.dev",
			clientEndpoint: aws.String("https://client-gamecast.dev"),
			expectURL:      aws.String("https://client-gamecast.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_GAMECAST", c.envService)
			}
